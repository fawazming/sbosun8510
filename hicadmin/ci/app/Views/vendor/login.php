...
<head>
	...
	<meta name="keywords" content="RayyanTech, HIC Statistics">
	<meta name="description" content="RayyanTech Admin Panel customized for HIC Delegate Statistics">
	<meta name="robots" CONTENT="noindex, nofollow">
	<meta property="og:title" content="HIC Admin Panel">
	<meta property="og:url" content="">
	<meta property="og:type" content="">
	<meta property="og:description" content="RayyanTech Admin Panel customized for HIC Delegate Statistics">
	<meta property="og:image" content="<?=base_url('assets/logo.png')?>">
	<meta name="twitter:card" content="">
	<meta name="twitter:title" content="HIC Admin Panel">
	<meta name="twitter:description" content="RayyanTech Admin Panel customized for HIC Delegate Statistics">
			...
			<div class="card auth-content mb-0">
				<div class="card-body py-5">
					<div class="text-center mb-5">
						...
						<div class="font-18 text-center">Welcome! <br>Login to Your account</div>
					</div>
					<form action="<?=base_url('vendor/auth')?>" method="post">
					<div class="mb-4">
						<div class="md-form mb-0"><input class="md-form-control" type="text" name="username" required><label>Access Code</label></div>
					</div>
					<!-- <div class="mb-4">
					...
					<div class="text-center mt-5 font-13">
						<div class="mb-2 text-muted">2023 © All rights reserved</div>
						<div><a class="hover-link ml-2" href="<?=base_url('stat')?>" style="border-bottom: 1px solid">Go to Statistics</a></div>
					</div>
				</div>
			</div>

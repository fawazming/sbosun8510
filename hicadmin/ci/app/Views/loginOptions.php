...
<head>
    ...
    <meta name="description" content="RayyanTech Admin Panel">
    ...
    <title>SB HIC :: Admin Panel</title><!-- GLOBAL VENDORS-->
        ...
        <div class="auth-wrapper">
            <div class="card auth-content mb-0">
                <div class="card-body py-5">
                    <div class="text-center mb-5">
                        ...
                        <div class="font-18 text-center">Welcome! <br>Login to vendor panel</div>
                    </div>
            ...
            <div class="card auth-content mb-0">
                <div class="card-body py-5">
                    <div class="text-center mb-5">
                        <h3 class="mb-3 text-primary"><img src="assets/logo.png" style="height: 70px; width: inherit;" alt="PHF Ogun" class="img-responsive"></a></h3>
                        <div class="font-18 text-center">Login to Statistics panel</div>
                    </div>
